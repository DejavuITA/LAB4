...
Ricordiamo che il circuito di alimentazione e di riduzione dei rumori (Figura \ref{gr:costante}) è il medesimo dell'esperienza precedente: negli schemi circuitali è dunque nascosta per facilitarne la comprensione.
