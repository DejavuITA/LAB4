\section{16.09.2014 - Amplificatori Operazionali Ideali}
...
Per (\ref{eq:regola_I}) e la legge di Kirchhoff sui nodi, avremo invece che la corrente passante per la resistenza di carico è uguale alla corrente di (\ref{eq:gen_1}) in modulo e varrà: $I=I_1=-I_2$.
...
In questa esperienza siamo riusciti a valutare il comportamento dell'opamp considerandolo ideale, in configurazione di generatore di corrente e sommatore pesato. In entrambi i casi, dati i valori di corrente e tensione, e avendo retro-azionato l'opamp, abbiamo notato l'idealità dell'amplificatore.