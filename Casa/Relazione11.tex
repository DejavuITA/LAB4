...
In questa prima parte dell'esperienza abbiamo costruito il FF SR utilizzando delle porte NAND.
...
Il circuito, come sempre, è stato verificato utilizzando la basetta a led.
...
Tale circuito ci permette di evitare i rimbalzi poiché quando la linguetta è scollegata sia dal SET che dal RESET abbiamo il circuito in configurazione memoria.
...
\centering
	\begin{subfigure}[hc]{.49\textwidth}
		...
		\label{gr11:no-rimb}
        \end{subfigure}
\caption{I due grafici riportano il comportamento degli interruttori: quello a sinistra è un interruttore semplice, quello a destra è un interruttore seguito da un circuito anti-rimbalzo.}
\end{figure}
...
Il circuito è riportato in Figura (\ref{cir11:marcia}).
...
Inoltre abbiamo osservato il funzionamento di un interruttore con e senza un dispositivo di anti-rimbalzo, creato con porte logiche.
