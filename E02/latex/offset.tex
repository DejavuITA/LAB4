...
$R_1[\si{\kilo\ohm}]$ & $R_2[\si{\kilo\ohm}]$ & Gain(inv) & Gain (non inv) &$V_{out}$ & $V_{off}$(inv) &$V_{off}$(non inv) \\ 
\hline 
$119.8\pm0.1$ & $9.911\pm0.001$  & $-82.7\pm??$ &$83.7\pm??$&  $-103.5 \pm 0.5$ & $-1.25 \pm??$ &\\
\hline
$119.8\pm0.1$ & $99.35\pm0.01$  & $-829.2\pm??$ & $830.2\pm??$ &$ -1025 \pm 2$ & $-1.23 \pm ??$ & \\

\end{tabular}
\end{savenotes}


Ricordiamo che i valori di tensione di offset ottenuti per configurazione invertente e non invertente differiscono nel segno in quanto è necessario che in entrambi sia rispettata la condizione $|V_{inv}|>|V_{ninv}|$
