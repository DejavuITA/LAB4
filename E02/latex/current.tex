...
Le resistenze sono state dimensionate tenendo invece conto dell'ordine di grandezza della corrente da misurare. Dunque abbiamo optato per una resistenza $R_B$ ($V^*=I_{b^-} R_B$) e un rapporto di amplificazione $R_2/R_1 \approx R_B/ \Omega$ tali da rendere leggibile la tensione date le scale possibili del multimetro.
...
\begin{wrapfigure}[15]{r}{0.55\textwidth}
  \begin{center}
    \includegraphics[width=0.30\textwidth]{../E02/latex/ninv_current.pdf}
  \end{center}
