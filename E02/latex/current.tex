...
\begin{wrapfigure}[15]{l}{0.55\textwidth}
  ...
  \end{center}
  \caption{Schema del circuito retro-azionato utilizzato per stimare la corrente di polarizzazione $I_{b^-}$. Le resistenze utilizzate sono $R_1=99.62\pm0.01$\si{\ohm}, $R_2=99.350\pm0.01$\si{\kilo\ohm} e $R_B=99.540\pm0.01$\si{\kilo\ohm}.}
...
La misura di tensione di uscita è di $(370\pm2)$ \si{\milli\volt} ed il valore ottenuto è dunque $I_{b^-} = (3.72 \pm 0.05)$ \si{\nano\ampere}.
...
\begin{wrapfigure}[17]{r}{0.55\textwidth}
  ...
  \end{center}
  \caption{Schema del circuito retro-azionato utilizzato per stimare la corrente di polarizzazione $I_{b^+}$. Le resistenze utilizzate sono le medesime del circuito precedente: $R_1=98.9\pm0.1$\si{\ohm}, $R_2=99.82\pm0.01$\si{\kilo\ohm} e $R_B=99.90\pm0.01$\si{\kilo\ohm}.}
...
ed inserendo i valori otteniamo $I_{b^+} = - (3.65 \pm 0.02)$ \si{\nano\ampere}, compatibile con il risultato precedente.
