...
\begin{wrapfigure}[17]{c}{0.7\textwidth}
	\begin{center}
...
Come si può notare dal grafico in Figura \ref{gr4:neon} il rumore ambientale dato dalle lampade al neon ha una forma d'onda sinusoidale di frequenza \SI{100}{\hertz} e ampiezza picco-picco \SI{80}{\mV}
...
\begin{wrapfigure}[16]{c}{0.7\textwidth}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{../E04/latex/neon.pdf}
	\end{center}
