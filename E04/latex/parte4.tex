...
\begin{figure}[ht]
 ...
 \caption{DIDASCALIA!! $R_F = \SI{1}{\Mohm}$, $R_1 = \SI{50}{\kohm}$ è formato da un parallelo di due resistenze da \SI{100}{\kohm}, $R_2 = \SI{100}{\kohm}$, $R_P = \SI{1}{\kohm}$, $R_S = \SI{10}{\kohm}$ è un trimmer resistivo}
