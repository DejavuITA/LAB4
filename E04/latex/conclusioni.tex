...
Durante l'esperienza abbiamo anche costruito un oscillatore a rilassamento.
Peculiarità di tale circuito è che esso oscilla tra $+V_{sat}$ e $-V_{sat}$ sebbene sia alimentato con tensioni continue.
