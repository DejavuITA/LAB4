...
# Titolo del grafico
fig1.suptitle(u'Risposta dell'"'"'oscillatore a rilassamento con $R=100k\Omega$', y=0.97, fontsize=15)
...
f1.text(-29, 0, u'Tensione [$V$]', size=12, va='center', ha='center',rotation='90')
