...
# Titolo del grafico
fig1.suptitle("Particolare della risposta del comparatore", y=0.97, fontsize=15)
...
f1.grid(True)
f1.set_ylim((-1.2, 5.2))
f1.set_xlim((-0.055,0.055))

f1.set_xlabel(u'Tempo [$m s$]', labelpad=0, fontsize=14)

f1.legend((g1, g2), (r'$V_{in}$', r'$V_{out}$'), 'lower left', prop={'size': 13})
