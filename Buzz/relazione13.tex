...
Infatti se il segnale $V_{in}$ è minore di quello in uscita dal DAC, avremo in uscita dal comparatore una tensione negativa e dunque gli ingressi del FF-JK saranno a zero logico.
...
Consideriamo una funzione $f(t)=Asin(\omega_0 t)$ con costante $A=\SI{5}{\V}$.
È possibile ottenere lo spettro della $f(t)$ utilizzando le trasformate di Fourier.
...
Ricordiamo che la trasformata di Fourier è eseguita sui dati utilizzando la una funzione chiamata FFT (Fast Fourier Transform).
