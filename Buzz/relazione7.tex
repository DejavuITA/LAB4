...
Questo operazionale è posto in un blocco con retroazione positiva invertente. Dunque il suo guadagno è dato da
\begin{equation}
	G_3=\frac{R_3}{R_2}\frac{1}{\sqrt{1+(2\pi C_2 R_3 \times \SI{1.25}{\Hz})^2}} \approx 10
\end{equation}
Tale stadio introduce un ulteriore filtro atto ad eliminare disturbi nelle alte frequenze.
