...
#### dati ####
data01 = np.genfromtxt("../dati/scope_4.csv", delimiter=',')
t_01 = data01[2:,0]
VS_01 = data01[2:,1]
...
out_teo = f1.errorbar(x=t_01*1000, y=(1.007*np.sin(t_01*3142-1.038)+0.2505*np.sin(t_01*3456-1.174)), fmt=':', c='red', linewidth=3)
