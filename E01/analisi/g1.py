...
#### dati ####
data01 = np.genfromtxt("../dati/scope_0.csv", delimiter=',')
t_01 = data01[2:,0]
VS_01 = data01[2:,1]
...
# Titolo del grafico
fig1.suptitle("Circuito sommatore: onde sinusoidali", y=0.97, fontsize=17)

# GRAFICO
f1 = host_subplot(111, axes_class=AA.Axes)

out1 = f1.errorbar(x=t_01*1000, y=VS_01, fmt='-', c='black', linewidth=2)
in1 = f1.errorbar(x=t_01*1000, y=0.5*np.sin(t_01*2*pi*100), fmt=':', c='red', linewidth=2)
in2 = f1.errorbar(x=t_01*1000, y=0.25*np.sin(t_01*2*pi*800), fmt='--', c='green', linewidth=2)
...
# plotta la legenda
f1.legend([out1, in2, in1], ['Output sommatore', 'Generatore 1', 'Generatore 2'])
