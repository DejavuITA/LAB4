\section{19.11.2014 - Porte logiche - Seconda Parte}
...
Per far ciò, dobbiamo innanzitutto negare i segnali $Q_i$ e inviarli separatamente ad una porta AND. Comportandosi come un Gate, avremo tutti i $D_i$ a zero tranne quello abilitato dal selettore, che dunque trasmetterà il dato. 
