...
dove l'ultimo valore è stato scelto per tenerci sempre abbastanza distanti. Dunque vale che
$$V_{in}<\frac{0.35 \si{\volt\per\micro\second}}{2 \pi G f_0} = \frac{0.35 \si{\volt\per\micro\second}}{2 \pi \mathrm{BWP}}$$
Considerando $f_0$ come la frequenza di taglio stimata prima, otteniamo che i valori di tensione da usare nei due casi è di circa $V_{in}^{11x} = 100$ \si{\milli\volt}$= V_{in}^{101x}$.