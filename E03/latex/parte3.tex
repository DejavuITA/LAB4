...
che nei due casi (amplificazione $11\mathrm{x}$ e $101\mathrm{x}$) ci restituisce i valori di $A_{ol}^{11\mathrm{x}} = $ e $A_{ol}^{101\mathrm{x}} = $. Nel paragrafo successivo verificheremo la compatibilità fra questi risultati e quelli misurati direttamente.