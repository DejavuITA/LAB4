...
#### dati ####
data01 = np.genfromtxt("../dati/scope_12.csv", delimiter=',')
t_01 = data01[2:,0]
VS_01 = data01[2:,1]
VS_02 = data01[2:,2]
...
f1.text(0, -13.5, r'tempo [$ms$]', rotation='horizontal',
	ha='center', va='center', fontsize=15)
f1.text(-0.089, 0, r'd.d.p. [$V$]', rotation='vertical',
	ha='center', va='center', fontsize=15)

f1.set_xlim((-0.085,0.085))
f1.set_ylim((-12,12))
