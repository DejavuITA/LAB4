...
#### dati ####
data01 = np.genfromtxt("../dati/nuovi/tt_0210_02.csv", delimiter=',') ##### ← cambiare qui con i file giusti
t_01 = data01[2:,0]
VS_01 = data01[2:,1]
VS_02 = data01[2:,2]

data02 = np.genfromtxt("../dati/nuovi/tt_0210_01.csv", delimiter=',') ##### ← cambiare qui con i file giusti
t_02 = data02[2:,0]
VS_11 = data02[2:,1]
VS_12 = data02[2:,2]
...
fig1.subplots_adjust(left=0.04, right=0.96,
    top=0.925, bottom=0.10, hspace=0.08, wspace=0.018)
