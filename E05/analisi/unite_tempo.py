...
dataG1_1 = np.genfromtxt("../dati/scope_0.csv", delimiter=',')

t_1	=1000* dataG1_1[2:,0]-0.99
V_in_1	= dataG1_1[2:,1]
V_ou_1	= dataG1_1[2:,2]
...
g2 = f5.errorbar(x=t_1, #x=np.logspace(70,6E6,500),
	y=V_ou_1,
	fmt='-', c='green')

f5.grid(True)
f5.set_ylim((-0.58, 0.58))
#f5.set_xlim((-25,25))

f5.set_xlabel(u'Tempo [$m s$]', labelpad=0, fontsize=14)
f5.text(-33.7, 0, u'Tensione [$V$]', size=14, va='center', ha='center',rotation='90')
f5.legend((g1, g2), (r'$V_{in}$', r'$V_{out}$'), 'center right', prop={'size': 13})

######

# questo imposta i bordi del grafico
fig1.subplots_adjust(left=0.04, right=0.98, top=0.93, bottom=0.095, hspace=0.085, wspace=0.095)
# mostra grafico
plt.show()
