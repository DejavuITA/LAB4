...
import numpy as np
	...
	####  Qui vanno i dati 	####
dataG1 = np.genfromtxt("../dati/scope_10.csv", delimiter=',')

t	=1000* dataG1[2:,0]-0.834
V_in	= dataG1[2:,1]
V_ou	= dataG1[2:,2]
...
# Titolo del grafico
fig1.suptitle("Particolare del raddrizzatore ottimizzato", y=0.97, fontsize=15)
...
f1.text(-0.0325, 0, u'Tensione [$V$]', size=14, va='center', ha='center',rotation='90')
