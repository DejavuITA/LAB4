...
# Titolo del grafico
fig1.suptitle("Segnale del raddrizzatore a mezz'onda prima del diodo", y=0.97, fontsize=15)
...
f1.text(-32.7,-6, u'Tensione [$V$]', size=14, va='center', ha='center',rotation='90')
