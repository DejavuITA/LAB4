...
import numpy as np
	...
	####  Qui vanno i dati 	####
dataG1 = np.genfromtxt("../dati/scope_12.csv", delimiter=',')

t	=1000* dataG1[2:,0]-0.03
V_in	= dataG1[2:,1]
V_ou	= dataG1[2:,2]
...
# Titolo del grafico
fig1.suptitle("Particolare del raddrizzatore a mezz'onda", y=0.97, fontsize=15)
...
f1.text(-0.705, 0, u'Tensione [$V$]', size=14, va='center', ha='center',rotation='90')
