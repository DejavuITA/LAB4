...
# Titolo del grafico
fig1.suptitle("Paricolare del raddrizzatore a mezz'onda", y=0.97, fontsize=15)
...
f1.text(-0.225,0, u'Tensione [$V$]', size=14, va='center', ha='center',rotation='90')
